        ...
        <div id='my-mdc-dialog'
          ...
          <div className='mdc-dialog__container'>
            <div className='mdc-dialog__surface'>
              <h2 id='my-mdc-dialog-label' className='mdc-theme--on-surface mdc-dialog__title'>Get this party started?</h2>
              <section id='my-mdc-dialog-description' className='mdc-theme--on-surface mdc-dialog__content'>
    ...
    return (
      <div>
        <div id='mdc-dialog-with-list'
          ...
          <div className='mdc-dialog__container'>
            <div className='mdc-dialog__surface'>
              <h2 id='mdc-dialog-with-list-label' className='mdc-theme--text-primary-on-background mdc-dialog__title'>The Wonderful Wizard of Oz</h2>
              <section id='mdc-dialog-with-list-description' className='mdc-theme--text-primary-on-background  mdc-dialog__content'>
